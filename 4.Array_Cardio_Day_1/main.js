...
const people = [
    ...
    'Beecher, Henry', 'Beethowen, Ludwig', 'Begin, Menachem', 'Belloc, Hilaire', 
    'Bellow, Saul', 'Benchley, Robert', 'Benenson, Peter', 'Ben-Gurion, David', 
    'Benjamin, Walter', 'Benn, Tony', 'Bennington, Chester', 'Benson, Leana', 
    'Bent, Silas', 'Bentsen, Lloyd', 'Berger, Rich', 'Bergman, Ingmar', 'Berio, Luciano', 
    ...
    'Biden, Joseph', 'Bierse, Ambrose', 'Biko, Steve', 'Billings, Josh', 'Biondo, Frank', 
...
// 6. create a list of Boulevards in Paris that contain 'de' anywere in the name
